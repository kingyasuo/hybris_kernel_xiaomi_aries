...
#ifdef CONFIG_TOUCHSCREEN_ATMEL_MXT_TS_S2W
#define DT2W_ENABLED 0       /* Disable Double-Tap-to-Wake by default */
#define DT2W_TIMEOUT_MAX 350 /* Maximum time between the two taps */
#define DT2W_TIMEOUT_MIN 100 /* Minimum time between the two taps */
#define DT2W_DELTA_X 50
#define DT2W_DELTA_Y 50

#define S2W_ENABLED 0        /* Disable Swipe-to-Wake by default */
#define S2W_START -1
#define S2W_END -1
#endif
...
static DEVICE_ATTR(disable_keys, 0666, mxt_disable_keys_show,
